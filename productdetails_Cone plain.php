  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Cone plain </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Blue berry.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Ice cream</span>
          <h1>Cone plain</h1>
          <div class="price">R10</div>
...
<?php } else { 
  ...
  <?php } else { ?>
    <a href="cart_add.php?id=28" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
  <?php } 
} ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Blue berry Plain Ice-Cream in a cup.
          </p>
        </div>
      </div>
    </section>
