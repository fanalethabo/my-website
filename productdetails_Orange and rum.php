  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Orange and Rum </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Orange & rum.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
...
<?php } else { 
  ...
  <?php } else { ?>
    <a href="cart_add.php?id=37" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
  <?php } 
} ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Orange juice and Rum infused cocktail.
          </p>
        </div>
      </div>
    </section>
