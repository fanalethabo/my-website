  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Coco and ger germister </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/coco & ger germister.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Cocktails</span>
          <h1>Coco & ger germister</h1>
...
<?php } else { 
  ...
  <?php } else { ?>
    <a href="cart_add.php?id=35" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
  <?php } 
} ?>
          </form>
          <h3>Product Detail</h3>
          <p>
        Coco and gergermister infused coctail.
          </p>
        </div>
      </div>
    </section>
