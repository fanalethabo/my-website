  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em>Flying Fish</em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Flying fish.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Beers</span>
          <h1>Flying Fish</h1>
          <div class="price">R22</div>
...
<?php } else { 
  ...
  <?php } else { ?>
    <a href="cart_add.php?id=43" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
  <?php } 
} ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Flying fish 750ml bottle.
          </p>
        </div>
      </div>
    </section>
