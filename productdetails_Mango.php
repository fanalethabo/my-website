  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Mango </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Mango.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Milkshakes</span>
          <h1>Mango</h1>
          <div class="price">R39</div>
        ...
        <?php } else { 
          ...
          <?php } else { ?>
            <a href="cart_add.php?id=22" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
          <?php } 
        } ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Milkshake with chopped Mango serving for 1.
          </p>
        </div>
      </div>
    </section>
