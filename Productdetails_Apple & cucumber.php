  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Apple & Cucumber  </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Apple & cucumber.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Mocktails</span>
          <h1>Apple & cucumber</h1>
        ...
        <?php } else { 
          ...
          <?php } else { ?>
            <a href="cart_add.php?id=9" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
          <?php } 
        } ?>
          ...
          <p>
          Squashed Apple with cucumber with a tint of cinnamon.
          </p>
        </div>
      </div>
    </section>
