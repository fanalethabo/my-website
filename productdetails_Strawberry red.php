  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Strawberry red </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Strawberry red.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Mocktails</span>
          <h1>Strawberry Red</h1>
        ...
        <?php } else { 
          ...
          <?php } else { ?>
            <a href="cart_add.php?id=15" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
          <?php } 
        } ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Strawberry juice with lime fruit.
          </p>
        </div>
      </div>
    </section>
