  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Black Berry </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/black berry.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
...
<?php } else { 
  ...
  <?php } else { ?>
    <a href="cart_add.php?id=32" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
  <?php } 
} ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Black berry mixed with rum cocktail.
          </p>
        </div>
      </div>
    </section>
