  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em>Passsion fruit </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Passion fruit.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span>Catergory = Mocktails</span>
          <h1>Passion fruit</h1>
          <div class="price">R57</div>
        ...
        <?php } else { 
          ...
          <?php } else { ?>
            <a href="cart_add.php?id=16" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
          <?php } 
        } ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          granadilla juice with sliced granadilla fruit.
          </p>
        </div>
      </div>
    </section>
