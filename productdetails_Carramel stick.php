  ...
  <body>
    ...
    <div class="top-nav">
      <div class="container d-flex">
        <marquee width="50%"> Product details-<em> Caramel stick </em></marquee>
        <ul class="d-flex">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Carramel stick.jpg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
...
<?php } else { 
  ...
  <?php } else { ?>
    <a href="cart_add.php?id=26" class="btn btn-block btn-primary" name="add" value="add">Add to cart</a>
  <?php } 
} ?>
          </form>
          <h3>Product Detail</h3>
          <p>
          Cadberry golden caramel chocolate with a creamy Ice cream center.
          </p>
        </div>
      </div>
    </section>
